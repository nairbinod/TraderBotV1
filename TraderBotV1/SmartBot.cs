...
namespace TraderBotV1
{
    ...
    public class SmartBot
    {
        ...
        private async Task UpdateTradedSymbols()
        {
            ...
            await CreateTradeHistoryDetails();
        }
        ...
        private async Task<IEnumerable<TradeRecord>> CreateTradeHistoryDetails()
        {
            try
            {
                ...
                foreach (var trade in th)
                {
                    ...
                    try
                    {
                        ...
                        var currentBar = await FetchCurrentPrice(trade.Symbol);
